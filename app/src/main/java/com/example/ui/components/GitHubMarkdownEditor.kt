...
fun GitHubMarkdownEditor(
  ...
  Column(
    ...
    Row(
      ...
      Row(
        ...
        TextButton(
          ...
          modifier = Modifier.height(38.dp).testTag("${testTagPrefix}_tab_write"),
        ...
        TextButton(
          ...
          modifier = Modifier.height(38.dp).testTag("${testTagPrefix}_tab_preview"),
          shape = RoundedCornerShape(topStart = 6.dp, topEnd = 6.dp)
        ) {
          Text(
            text = "Preview",
      ...
      if (viewMode == "write") {
        LazyRow(
          modifier = Modifier.weight(1f).padding(start = 8.dp).testTag("markdown_toolbar"),
    ...
    if (viewMode == "preview") {
      Surface(
        modifier = Modifier.fillMaxWidth().heightIn(min = 120.dp, max = 300.dp).padding(8.dp),
      ...
      Row(
        ...
        Row(
          ...
          horizontalArrangement = Arrangement.spacedBy(4.dp),
          modifier =
            Modifier.testTag("markdown_footer_attachment_hint").clickable {
...
fun ToolbarButton(
  ...
  Box(
    modifier =
      Modifier.size(48.dp) // Touch target compliance (minimum 48dp x 48dp)
        .testTag(testTag)
